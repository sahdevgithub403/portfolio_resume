...
export const Home = () => {
  ...
  return (
    ...
    >
      ...
      {!isBroken && <Marquee text="HIRE ME BEFORE AI TAKES MY JOB" />}
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  <ul className="space-y-4 font-bold">
                    ...
                    >
                      <span>GitHub:</span>
                      <Link to={portfolioData.githubUrl}>
                        <FaGithub />
                      </Link>
                    </li>
                    <li
                    ...
                    >
                      <span>Linkedin:</span>{" "}
                      <Link to={portfolioData.linkedinUrl}><BsLinkedin/></Link>
                    </li>
                    <li
                      className={`flex justify-between border-b-2 border-dashed pb-2 ${
                        hackerMode ? "border-green-500" : "border-black"
                    ...
                    >
                       <span>Resume:</span>
                      <Link to={portfolioData.resumeUrl}><PiReadCvLogoFill size={20}/></Link> 
                    </li>
                  </ul>
                </BrutalCard>
  ...
  <a
    href={project.github}
    className={`flex-1 text-center py-2 font-bold transition-colors flex items-center justify-center gap-2 ${
      hackerMode
